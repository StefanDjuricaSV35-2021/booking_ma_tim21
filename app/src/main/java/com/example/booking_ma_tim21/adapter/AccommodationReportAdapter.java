...
import com.example.booking_ma_tim21.adapter.accommodation_review.AccommodationReviewViewHolder;
...
public class AccommodationReportAdapter extends RecyclerView.Adapter<AccommodationReportViewHolder> {
    ...
    @NonNull
    @Override
    public AccommodationReportViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AccommodationReportViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AccommodationReportViewHolder holder, int position) {
    ...
    public void getReview(Long reviewId, AccommodationReportViewHolder holder) {
    ...
    public void getReporter(Long userId, AccommodationReportViewHolder holder) {
    ...
    public void getReviewer(Long userId, AccommodationReportViewHolder holder) {
        Call<UserDTO> call = userService.getUser(userId);
        call.enqueue(new Callback<UserDTO>() {
            @Override
            public void onResponse(Call<UserDTO> call, Response<UserDTO> response) {
                ...
                holder.reviewerEmail.setText(reviewerEmail);
